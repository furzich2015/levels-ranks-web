...
<aside class="sidebar-right unshow">
    <section class="sidebar">
        <div class="user-sidebar-right-block">
            <div class="info">
                <div class="details">
                    <div class="admin_type"><?php echo $Translate->get_translate_module_phrase( 'module_page_','_Chief_admin')?></div>
                    <div class="admin_rights"><?php echo $Translate->get_translate_module_phrase( 'module_page_','_All_access_rights')?></div>
                </div>
            </div>
        </div>
        <div class="card menu">
